...
def face_comparison(image_name_1, image_name_2):
  ...
  if face_locations1 and face_locations2:  # Ensure faces are detected
      face_encoding1 = face_recognition.face_encodings(rgb_image1, [face_locations1[0]])[0]
      face_encoding2 = face_recognition.face_encodings(rgb_image2, [face_locations2[0]])[0]
...
def test():
  test_photo = "fullbody-multiple.JPG"
  opt_out_face = "opt-out.JPG"
